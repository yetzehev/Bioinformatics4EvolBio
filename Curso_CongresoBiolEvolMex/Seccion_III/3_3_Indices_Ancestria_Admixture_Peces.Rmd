...
```{r input.file}
system( "/home/irojas/bin/plink/plink --vcf ./subset/radiator_data_20220330_1452_neutral.vcf --make-bed --allow-extra-chr --out ./subset/plectopromus ")
...
```{r ADMIXTURE}
#system("bash -c 'for K in {1..7}; do ~/bin/admixture_linux-1.3.0/admixture -s time --cv=10 -j4 ./subset/plectopromus.bed $K | tee ./results/plectopromus_${K}.out; done'")
