...
Este curso es un extracto del **Módulo II** del curso de **Genómica de Poblaciones**, desarrollado por los integrantes de la **ReMBE**. El curso ha sido adaptado para cubrir el manejo de datos y su visualización, utilizando paquetes y librerías disponibles en **RStudio**.
...
**2.1. R y RStudio** (Daniela Félix)
**2.2. Objetos de R** (Daniela Félix)
**2.3. Formatos de datos en Bioinformática** ([Fuente](https://www.formbio.com/blog/your-essential-guide-different-file-formats-bioinformatics))

- **2.3.1** FASTA (Idalia Rojas)
- **2.3.2** Variant Calling File (VCF) (Idalia Rojas)
- **2.3.3** Plink (Idalia Rojas)
- **2.3.5** BAM, SAM, BED (Idalia Rojas)
- **2.3.5**Genepop (Daniela Félix)
- **2.3.6** GTF, GFF (Daniela Félix)
- **2.3.7** Metadatos (Daniela Félix)

**2.4. Transformación de formatos**

- **2.4.1** PGD Spider ([Enlace](https://software.bioinformatics.unibe.ch/pgdspider/)) (Daniela Félix)
- **2.4.2** Paqueterías y herramientas en R (Daniela Félix)
...
- **2.6.3** Filogenias (genes, SNPs): Neighbor-Joining y Máxima Verosimilitud (Daniela)